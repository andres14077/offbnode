...
void GimbalControllerPlugin::OnUpdate()
{
  ...
  else if (time > this->lastUpdateTime)
  {
    ...
    // gzerr << "cmd[ " << this->rollCommand*57.2957
    //       << ", " << this->pitchCommand*57.2957 << ", " << this->yawCommand*57.2957
    //       << "] angulo[ " <<  currentAnglePRYVariable.Y()*57.2957
    //       << ", " << currentAnglePRYVariable.X()*57.2957 << ", " << currentAnglePRYVariable.Z()*57.2957
    //       << "] err[ " << rollError*57.2957
    //       << ", " << pitchError*57.2957 << ", " << yawError*57.2957
    //       << "] frc[ " << rollForce
    //       << ", " << pitchForce << ", " << yawForce
    //       << "] lastImuYaw [ " << this->lastImuYaw*57.2957 << "]\n";
