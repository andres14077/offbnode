...
class procesado_plc_2:
    def __init__(self):
        ...
        self.int_sub=rospy.Subscriber('offbnode/num_of_plane', Int32, self.int_cb )
    ...
    def int_cb(self,msg):
        ...
        t=TransformStamped()
        self.t.append(t)
        self.t[self.i].transform.rotation.w = 1
        self.t[self.i].header.frame_id = "map"
        self.t[self.i].child_frame_id = "plano_terreno_" + str(self.i)
    def point_cb(self,msg):
        ...
        self.t[self.i].transform.translation.x = point_t.point.x
        self.t[self.i].transform.translation.y = point_t.point.y
        self.t[self.i].transform.translation.z = point_t.point.z
    def vector_cb(self,msg):
        ...
        self.t[self.i].transform.rotation.x = q[0]
        self.t[self.i].transform.rotation.y = q[1]
        self.t[self.i].transform.rotation.z = q[2]
        self.t[self.i].transform.rotation.w = q[3]
    def update(self):
